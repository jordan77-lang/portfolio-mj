class ChemHeader extends HTMLElement {
  connectedCallback() {
    ...
    const training = this.getAttribute('training') || 'Relative Frequency';
      ...
      <header>
        <div class="container">
          ...
          <nav>
            ...
            <a href="step1.html" class="${current === 'step1.html' ? 'active' : ''}" ${current === 'step1.html' ? 'aria-current="page"' : ''}>Frequency</a>
            <a href="step2.html" class="${current === 'step2.html' ? 'active' : ''}" ${current === 'step2.html' ? 'aria-current="page"' : ''}>Calculate</a>
