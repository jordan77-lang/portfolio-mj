class ChemHeader extends HTMLElement {
  connectedCallback() {
    ...
    const training = this.getAttribute('training') || 'Interpreting Distributions';

    // Determine step number for visual indicator
    const steps = ['index.html', 'step1.html', 'step2.html', 'step3.html', 'practice.html', 'summary.html'];
      ...
      <header>
        <div class="container">
          <div class="left-section">
            <div class="title-row">
              <img src="images/collogo.png" alt="Colonel Logo" class="logo" style="width: 32px; height: 32px; object-fit: contain;">
              <h1>${training}</h1>
            </div>
          ...
          <nav>
            ...
            <a href="step1.html" class="${current === 'step1.html' ? 'active' : ''}" ${current === 'step1.html' ? 'aria-current="page"' : ''}>Distributions</a>
            <a href="step2.html" class="${current === 'step2.html' ? 'active' : ''}" ${current === 'step2.html' ? 'aria-current="page"' : ''}>Peaks</a>
            <a href="step3.html" class="${current === 'step3.html' ? 'active' : ''}" ${current === 'step3.html' ? 'aria-current="page"' : ''}>Shape</a>
